    ...
    <EthereumContext.Provider value={{ web3Provider, blockNumber }}>
      <div className='container mx-auto max-w-screen-sm px-4'>
        <nav className='flex sm:flex-row flex-col items-center py-4 mb-6 border-b-2 border-black'>
          ...
          <div className='sm:justify-center sm:py-0 sm:px-4 py-2'><img className='mx-auto' width='25px' src={ keyImage } /></div>
        </nav>
        { !!!web3Provider && 
        ...
        <footer className='sm:flex sm:space-evenly py-4 mt-6 border-t-2 border-black'>
          <p className='sm:flex-1 sm:text-left text-center'><a href='https://mumbai.polygonscan.com/token/0xd9fdd544c7db7a69d87755cc702dee49e44c4857' target='_blank'>Token contract</a></p>
          <p className='sm:flex-1 sm:text-right text-center'><a href='https://www.hagen-schupp.me' target='_blank'>Hagen Schupp, 2021</a></p>
        </footer>
      </div>
